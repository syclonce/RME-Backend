...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    Route::apiResource('transfer-med-reconciliations', TransferMedicationReconciliationController::class)->only(['store', 'update'])->parameters(['transfer-med-reconciliations' => 'record']);
});
